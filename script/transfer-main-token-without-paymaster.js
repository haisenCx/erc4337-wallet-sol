...
async function main() {
    ...
    // await entryPoint.simulateValidation(params, {gasLimit: 100000} ).then(function (err, hash) {
    //     console.log("hash:" + hash);
    //     if (err) {
    //         console.log(err);
    //     }});
    const simulateValidationRes = await entryPoint.simulateValidation(params, {gasLimit: 100000});
    // expect(simulateValidationRes.to.be.revertedWith('ValidationResult'));
    // console.log(simulateValidationRes);
